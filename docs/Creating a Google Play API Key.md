...
# 
![SIL Logo](docs/images/SIL_logo.png)

# ![Quill and ink](docs/images/quill_ink.png) Creating a Google Play API Key
...
![Google Cloud create project](docs/images/creating_google_key_ima1.png)   
To create a project:

1. In the menu bar of the website, click on the **Select a project** dropdown.

![Select project](docs/images/creating_google_key_ima2.png)

2. In the **Select a project** dialog, click on the **NEW PROJECT** link

![Select New project in select a project dialog](docs/images/creating_google_key_ima3.png)
...
![New Project selecting an organization](docs/images/creating_google_key_ima4.png)
...
![Select a pre-existing project](docs/images/creating_google_key_ima5.png)

2. In the Select a project dialog, click on the link for the project name.

![Click on the link of the project name](docs/images/creating_google_key_ima6.png)
You should now see the project name displayed in the **Select a project** dropdown.

![See the Select a project in dropdown](docs/images/creating_google_key_ima7.png)
...
![Product Details](docs/images/creating_google_key_ima8.png)
...
![Service Accounts](docs/images/creating_google_key_ima9.png)
...
![IAM & Admin in popular searches](docs/images/creating_google_key_ima10.png)
...
![Create Service account](docs/images/creating_google_key_ima11.png)

4. Enter a **Service account name** (e.g. YOUR\_ORG\_NAME-scriptoria) and **Service account description** (optional)

![Service account name](docs/images/creating_google_key_ima12.png)

5. Click on **CREATE AND CONTINUE**  
6. Set **Grant this service account access to project (optional)** to **Basic** \> **Owner**   
   

![Grant this service account access to the project](docs/images/creating_google_key_ima13.png)

7. Click on **CONTINUE**

![Click continue](docs/images/creating_google_key_ima14.png)

8. Click on **DONE**  
9. On the row with the new service account, click on the vertical dot menu and click on **Manage keys**

![Manage keys](docs/images/creating_google_key_ima15.png)

10. On the Keys page, click **ADD KEY** and then **Create new key**

![Add Key](docs/images/creating_google_key_ima16.png)
...
![Use JSON Key Type](docs/images/creating_google_key_ima17.png)
...
![Click back arrow](docs/images/creating_google_key_ima18.png)
...
![Find the Copy icon](docs/images/creating_google_key_ima19.png)
...
![Give permisson to the service account in your Google Play Console](docs/images/creating_google_key_ima20.png)
