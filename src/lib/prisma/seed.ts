...
async function main() {
  ...
  const storeLanguages: StoreLanguage[] = [
    ...
    [18, 'en-AU', 'English (Australia) – en-AU', 1],
    ...
    [24, 'fr-FR', 'French (France) – fr-FR', 1],
    ...
    [73, 'sq', 'Albanian – sq', 1],
    [74, 'zh-HK', 'Chinese (Hong Kong) – zh-HK', 1],
    [75, 'en-CA', 'English (Canada) – en-CA', 1],
    [76, 'en-IN', 'English – en-IN', 1],
    [77, 'en-SG', 'English – en-SG', 1],
    [78, 'en-ZA', 'English – en-ZA', 1],
    [79, 'gu', 'Gujarati – gu', 1],
    [80, 'kk', 'Kazakh – kk', 1],
    [81, 'ms-MY', 'Malay (Malaysia) – ms-MY', 1],
    [82, 'fa-AE', 'Persian – fa-AE', 1],
    [83, 'fa-AF', 'Persian – fa-AF', 1],
