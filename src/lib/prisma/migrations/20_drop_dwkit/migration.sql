...
-- DropView
DROP VIEW IF EXISTS "public"."dwV_Security_CheckPermissionGroup";

-- DropView
DROP VIEW IF EXISTS "public"."dwV_Security_CheckPermissionUser";

-- DropView
DROP VIEW IF EXISTS "public"."dwV_Security_UserRole";
