...
<ul>
  ...
  <li>
    ...
    link on the right side of the page and complete the following items:
    <ul>
      <li>
  ...
  <li>
    Select <strong>Monitor and Improve</strong>
    &gt;
    <strong>Policy and programs</strong>
    &gt;
    <strong>App content</strong>
    section in the menu on the left and do the following:
    <ul>
      <li>
        Under the <strong>Privacy policy</strong>
        section, click the
      ...
      <li>
        ...
        <ul>
          <li>
            ...
            , my app does not contain ads radio button.
          </li>
          <li>
            Click the <strong>Save</strong>
            button at the bottom of the page.
      ...
      <li>
        Under the <strong>App access</strong>
        section, click the
        <strong>Start declaration</strong>
        button.
        <ul>
      ...
      <li>
        Under the <strong>Content ratings</strong>
        section, click the
        <strong>Start declaration</strong>
        button.
        <ul>
      ...
      <li>
        Under the <strong>Target audience and content</strong>
        section, click the
        <strong>Start declaration</strong>
        button.
        <ul>
          <li>
            Check the appropriate <strong>Target age groups</strong>
            for the app (we suggest
            <strong>13-15</strong>
            ,
            <strong>16-17</strong>
            , and
      ...
      <li>
        Under the <strong>Data safety</strong>
        section, click the
        <strong>Start declaration</strong>
        button.
        <ul>
      ...
      <li>
        Under the <strong>Advertising ID</strong>
        section, click the
        <strong>Start declaration</strong>
        button.
        <ul>
      ...
      <li>
        Under the <strong>Government apps</strong>
        section, click the
        <strong>Start declaration</strong>
        button.
        <ul>
  ...
  <ul>
    <li>
      Click the <strong>Countries / regions</strong>
      tab in the center of the screen and do the following:
      <ul>
        <li>
    ...
    <li>
      On the right, click <strong>Create new release</strong>
      button at the top of the page and complete the following items:
      <ul>
        <li>
