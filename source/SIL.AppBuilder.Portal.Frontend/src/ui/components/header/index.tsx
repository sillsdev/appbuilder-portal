...
const Header = () => (
  <Menu className='menu-navbar'>
    <Container>
      <Menu.Item header>SCRIPTORIA</Menu.Item>
      <Menu.Menu position='right'>
        <Menu.Item>
          <Button>Add Project</Button>
        </Menu.Item>
        <Menu.Item className='notification-item'>
          <Dropdown className='notification-dropdown' trigger={notificationTrigger} pointing='top right' icon={null}>
            <Dropdown.Menu>
        ...
        <Menu.Item>
          <Dropdown className='avatar-dropdown' trigger={avatarTrigger} pointing='top right' icon={null}>
            <Dropdown.Menu>
