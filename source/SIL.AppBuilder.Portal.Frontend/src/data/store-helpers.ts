...
import { QueryBuilder, QueryOrExpression, FindRecordTerm, FindRecord, QueryExpression } from '@orbit/data';
...
export function buildFindRecord(q: QueryBuilder, type: string, id: string): any {
