...
import { ShowSidebarAction, SHOW_SIDEBAR, reducer as showReducer } from './actions/show-sidebar';
import { HideSidebarAction, HIDE_SIDEBAR, reducer as hideReducer } from './actions/hide-sidebar';
...
type ActionTypes = ShowSidebarAction | HideSidebarAction;
