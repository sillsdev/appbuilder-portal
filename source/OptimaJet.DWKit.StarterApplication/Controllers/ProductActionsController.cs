...
namespace OptimaJet.DWKit.StarterApplication.Controllers
{
    ...
    public class ProductActionsController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult> GetProductActionsAsync([FromBody] ProductActionProjectIds body)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> RunProductActionsAsync([FromBody] ProductActionRunRequest body)
        {
