...
{
    public class UserTaskHookNotifier : BaseHookNotifier<UserTask, int> 
    {
        public UserTaskHookNotifier(
        ...
        protected override async void PublishResourceAsync(int id, UserTask resource, string operation) 
        {
           if (resource == null) {
