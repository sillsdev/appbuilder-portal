...
DEFAULT_BUILDENGINE_URL=https://dev-buildengine.scriptoria.io:8443
APP_ENV=dev
...
Set `DEFAULT_BUILDENGINE_URL` in your `.env` file to the URL of the [AppBuilder BuildEngine](https://github.com/sillsdev/appbuilder-buildengine-api) instance you want to use.
